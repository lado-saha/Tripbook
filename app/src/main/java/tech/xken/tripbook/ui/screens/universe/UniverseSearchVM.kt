...
//        savedStateHandle[UniverseArgs.UNIV_SEARCH_HAS_PRESELECTED_FIELDS]?: false
//    )
...
//                                data.data.sortedBy { it.name }.associateBy { it.countryId }
//                        }
//                    }
//
...
//                                data.data.sortedBy { it.name }.associateBy { it.regionId }
//                        }
//                    }
//
...
//                                data.data.sortedBy { it.name }.associateBy { it.divisionId }
//                        }
//                    }
//
...
//                                data.data.sortedBy { it.name }.associateBy { it.subdivisionId }
//                        }
//                    }
//
...
//                                data.data.sortedBy { it.name }.associateBy { it.townId }
//                        }
//                    }
//
//                onQueryChange("")
...
//                                it.townId,
//                                R.string.lb_town
//                            ) || isSelected(it.townId, R.string.lb_town)
//                        }.fold("") { acc, town -> "$acc ${town.townId}" },
